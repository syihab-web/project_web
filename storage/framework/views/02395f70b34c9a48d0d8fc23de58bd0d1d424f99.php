...
<body>
    <div id="app">
        <nav class="navbar navbar-fixed navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item">
                                <a href="<?php echo e(URL('continent')); ?>" class="nav-link">Benua</a>
                            </li>
                        </ul>
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item">
                                <a href="<?php echo e(URL('provinsi')); ?>" class="nav-link">Jumlah Covid</a>
                            </li>
                        </ul>
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item">
                                <a href="<?php echo e(URL('country')); ?>" class="nav-link">Country</a>
                            </li>
                        </ul>
